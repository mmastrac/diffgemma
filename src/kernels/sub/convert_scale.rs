...
pub const SHADER: &str = shader_include::include_metal!("kernels/convert_scale.metal");
...
pub fn bind_gpu_buffers(
    ...
    super::gpu_common::set_bytes(enc, &src_base, 2);
    super::gpu_common::set_bytes(enc, &dst_base, 3);
    super::gpu_common::set_bytes(enc, &len, 4);
    super::gpu_common::set_bytes(enc, &scale, 5);
}
