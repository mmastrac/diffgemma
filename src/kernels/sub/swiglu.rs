...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod split_tiny,
        cpu = crate::kernels::sub::swiglu::cpu_split_mul,
        cpu_oracle = crate::kernels::sub::swiglu::cpu_split_mul,
        gpu = crate::kernels::sub::swiglu::gpu_split_mul,
        fixture = crate::kernels::sub::swiglu::split_tiny_fixture,
        out_len = crate::kernels::sub::swiglu::SplitFixture::len,
        formats: [F32],
        max_tol = 1e-5,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::swiglu::cpu_split_mul,
        gpu = crate::kernels::sub::swiglu::gpu_split_mul,
        fixture = crate::kernels::sub::swiglu::split_moe_inter_fixture,
        out_len = crate::kernels::sub::swiglu::SplitFixture::len,
        formats: [F32],
        max_tol = 1e-5,
        min_cos = 0.9999,
    ...
    kernel_oracle_matrix! {
        mod half_tiny,
        cpu = crate::kernels::sub::swiglu::cpu_half_glu,
        cpu_oracle = crate::kernels::sub::swiglu::cpu_oracle_half_glu,
        gpu = crate::kernels::sub::swiglu::gpu_half_glu,
        fixture = crate::kernels::sub::swiglu::half_tiny_fixture,
        out_len = crate::kernels::sub::swiglu::HalfFixture::len,
        formats: [F32],
        max_tol = 1e-3,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu = crate::kernels::sub::swiglu::cpu_interleaved,
        cpu_oracle = crate::kernels::sub::swiglu::cpu_oracle_interleaved,
        gpu = crate::kernels::sub::swiglu::gpu_interleaved,
        fixture = crate::kernels::sub::swiglu::interleaved_tiny_fixture,
        out_len = crate::kernels::sub::swiglu::InterleavedFixture::out_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::swiglu::cpu_oracle_interleaved,
        gpu = crate::kernels::sub::swiglu::gpu_interleaved,
        fixture = crate::kernels::sub::swiglu::interleaved_moe_fixture,
        out_len = crate::kernels::sub::swiglu::InterleavedFixture::out_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
