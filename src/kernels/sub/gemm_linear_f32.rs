...
const SHADER: &str = shader_include::include_metal!("kernels/gemm_linear_f32.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny_q4,
        cpu = crate::kernels::sub::gemm_linear_f32::cpu,
        cpu_oracle = crate::kernels::sub::gemm_linear_f32::cpu_oracle,
        gpu = crate::kernels::sub::gemm_linear_f32::gpu_q4,
        fixture = crate::kernels::sub::gemm_linear_f32::tiny_fixture_q4,
        out_len = crate::kernels::sub::gemm_linear_f32::fixture_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu = crate::kernels::sub::gemm_linear_f32::cpu,
        cpu_oracle = crate::kernels::sub::gemm_linear_f32::cpu_oracle,
        gpu = crate::kernels::sub::gemm_linear_f32::gpu_nvfp4,
        fixture = crate::kernels::sub::gemm_linear_f32::tiny_fixture_nvfp4,
        out_len = crate::kernels::sub::gemm_linear_f32::fixture_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
