...
impl Fixture {
    ...
    pub fn w_q4(&self) -> Vec<u8> {
        quantize_f32_matrix_q4(&self.w_f32, self.n, self.k)
    }
}
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::gemm_q4::cpu,
        cpu_oracle = crate::kernels::sub::gemm_q4::cpu_oracle,
        gpu = crate::kernels::sub::gemm_q4::gpu,
        fixture = crate::kernels::sub::gemm_q4::tiny_fixture,
        out_len = crate::kernels::sub::gemm_q4::fixture_len,
        formats: [F32],
        max_tol = 0.05,
        min_cos = 0.999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::gemm_q4::cpu_oracle,
        gpu = crate::kernels::sub::gemm_q4::gpu,
        fixture = crate::kernels::sub::gemm_q4::tile_fixture,
        out_len = crate::kernels::sub::gemm_q4::fixture_len,
        formats: [F32],
        max_tol = 0.05,
        min_cos = 0.999,
