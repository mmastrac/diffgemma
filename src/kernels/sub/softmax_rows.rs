...
const SHADER: &str = shader_include::include_metal!("oracle/softmax_rows.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        ...
        fixture = crate::kernels::sub::softmax_rows::tiny_fixture,
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::softmax_rows::cpu_oracle,
        gpu = crate::kernels::sub::softmax_rows::gpu,
        fixture = crate::kernels::sub::softmax_rows::router_fixture,
        out_len = crate::kernels::sub::softmax_rows::fixture_len,
        formats: [F32],
        max_tol = 1e-5,
        min_cos = 0.9999,
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::softmax_rows::cpu_oracle,
        gpu = crate::kernels::sub::softmax_rows::gpu,
        fixture = crate::kernels::sub::softmax_rows::wide_cols_fixture,
        out_len = crate::kernels::sub::softmax_rows::fixture_len,
        formats: [F32],
        max_tol = 1e-5,
        min_cos = 0.9999,
