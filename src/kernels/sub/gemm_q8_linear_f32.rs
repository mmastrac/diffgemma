...
const SHADER: &str = shader_include::include_metal!("kernels/gemm_q8_linear_f32.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::gemm_q8_linear_f32::cpu,
        cpu_oracle = crate::kernels::sub::gemm_q8_linear_f32::cpu_oracle,
        gpu = crate::kernels::sub::gemm_q8_linear_f32::gpu,
        fixture = crate::kernels::sub::gemm_q8_linear_f32::tiny_fixture,
        out_len = crate::kernels::sub::gemm_q8_linear_f32::fixture_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
    }
