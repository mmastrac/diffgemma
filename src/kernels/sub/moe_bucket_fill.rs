...
use crate::kernels::cpu::moe_router::{moe_bucket_phases, pack_bucket_state};
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::moe_bucket_fill::cpu,
        cpu_oracle = crate::kernels::sub::moe_bucket_fill::cpu_oracle,
        gpu = crate::kernels::sub::moe_bucket_fill::gpu,
        fixture = crate::kernels::sub::moe_bucket_fill::tiny_fixture,
        out_len = crate::kernels::sub::moe_bucket_fill::fixture_len,
        formats: [F32],
        max_tol = 0.0,
        min_cos = 1.0,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::moe_bucket_fill::cpu_oracle,
        gpu = crate::kernels::sub::moe_bucket_fill::gpu,
        fixture = crate::kernels::sub::moe_bucket_fill::unique_fixture,
        out_len = crate::kernels::sub::moe_bucket_fill::fixture_len,
        formats: [F32],
        max_tol = 0.0,
        min_cos = 1.0,
