...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::gelu_pytorch_tanh::cpu,
        cpu_oracle = crate::kernels::sub::gelu_pytorch_tanh::cpu_oracle,
        gpu = crate::kernels::sub::gelu_pytorch_tanh::gpu,
        fixture = crate::kernels::sub::gelu_pytorch_tanh::tiny_fixture,
        out_len = crate::kernels::sub::gelu_pytorch_tanh::fixture_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::gelu_pytorch_tanh::cpu_oracle,
        gpu = crate::kernels::sub::gelu_pytorch_tanh::gpu,
        fixture = crate::kernels::sub::gelu_pytorch_tanh::mlp_shape_fixture,
        out_len = crate::kernels::sub::gelu_pytorch_tanh::fixture_len,
        formats: [F32],
        max_tol = 1e-4,
        min_cos = 0.9999,
