...
mod roundtrip_tests {
    use crate::kernels::sub::f16::round_half;
    use crate::kernels::sub::gpu_common::set_bytes;
    use crate::kernels::sub::kv_quant::{KvFormat, q8_roundtrip, rel_rms};
    ...
    fn pack_then_unpack(
        ...
        use crate::kernels::sub::unpack_encoder_kv as unpack;
    ...
    fn pack_then_hydrate(
        ...
        let pack_pipe =
            super::pipeline_fmt_for(&ctx, KernelVariant::PRODUCTION, fmt).expect("pack pipe");
        let hyd_pipe = crate::kernels::sub::kv_f32_side_hydrate::pipeline_for_kv(
            &ctx,
