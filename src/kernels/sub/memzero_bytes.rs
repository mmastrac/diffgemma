...
const SHADER: &str = shader_include::include_metal!("kernels/memzero_bytes.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::memzero_bytes::cpu,
        cpu_oracle = crate::kernels::sub::memzero_bytes::cpu_oracle,
        gpu = crate::kernels::sub::memzero_bytes::gpu,
        fixture = crate::kernels::sub::memzero_bytes::tiny_fixture,
        out_len = crate::kernels::sub::memzero_bytes::fixture_len,
        formats: [F32],
        max_tol = 0.0,
        min_cos = 1.0,
    }
