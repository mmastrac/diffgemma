...
const SHADER: &str = shader_include::include_metal!("kernels/gather_prob_cols.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::gather_prob_cols::cpu,
        cpu_oracle = crate::kernels::sub::gather_prob_cols::cpu_oracle,
        gpu = crate::kernels::sub::gather_prob_cols::gpu,
        fixture = crate::kernels::sub::gather_prob_cols::tiny_fixture,
        out_len = crate::kernels::sub::gather_prob_cols::fixture_len,
        formats: [F32],
        max_tol = 1e-6,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::gather_prob_cols::cpu_oracle,
        gpu = crate::kernels::sub::gather_prob_cols::gpu,
        fixture = crate::kernels::sub::gather_prob_cols::lm_head_chunk_fixture,
        out_len = crate::kernels::sub::gather_prob_cols::fixture_len,
        formats: [F32],
        max_tol = 1e-6,
        min_cos = 0.9999,
