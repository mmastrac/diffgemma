...
const SHADER: &str = shader_include::include_metal!("kernels/sample_apply.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::sample_apply::cpu,
        cpu_oracle = crate::kernels::sub::sample_apply::cpu_oracle,
        gpu = crate::kernels::sub::sample_apply::gpu,
        fixture = crate::kernels::sub::sample_apply::tiny_fixture,
        out_len = crate::kernels::sub::sample_apply::fixture_len,
        formats: [F32],
        max_tol = 1e-3,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::sample_apply::cpu_oracle,
        gpu = crate::kernels::sub::sample_apply::gpu,
        fixture = crate::kernels::sub::sample_apply::wide_fixture,
        out_len = crate::kernels::sub::sample_apply::fixture_len,
        formats: [F32],
        max_tol = 1e-2,
        min_cos = 0.9999,
