...
const SHADER: &str = shader_include::include_metal!("kernels/embed_gather.metal");
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny,
        cpu = crate::kernels::sub::embed_gather::cpu,
        cpu_oracle = crate::kernels::sub::embed_gather::cpu_oracle,
        gpu = crate::kernels::sub::embed_gather::gpu,
        fixture = crate::kernels::sub::embed_gather::tiny_fixture,
        out_len = crate::kernels::sub::embed_gather::fixture_len,
        formats: [F32],
        max_tol = 0.002,
        min_cos = 0.9999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::kernels::sub::embed_gather::cpu_oracle,
        gpu = crate::kernels::sub::embed_gather::gpu,
        fixture = crate::kernels::sub::embed_gather::tile_fixture,
        out_len = crate::kernels::sub::embed_gather::fixture_len,
        formats: [F32],
        max_tol = 1e-2,
        min_cos = 0.9999,
