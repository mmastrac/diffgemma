...
use crate::shaders::gemm_linear_grouped::{Fixture, grouped_fixture};
...
#[cfg(target_os = "macos")]
pub fn gpu_q4(f: &Fixture, variant: crate::shaders::KernelVariant) -> Result<Vec<f32>, Error> {
    gpu(
        f,
        crate::shaders::KernelVariant {
...
#[cfg(target_os = "macos")]
pub fn gpu_nvfp4(f: &Fixture, variant: crate::shaders::KernelVariant) -> Result<Vec<f32>, Error> {
    gpu(
        f,
        crate::shaders::KernelVariant {
...
pub fn gpu_on_blob(
    ...
    _variant: crate::shaders::KernelVariant,
...
mod tests {
    ...
    kernel_oracle_matrix! {
        mod tiny_q4,
        cpu = crate::shaders::gemm_block_grouped::cpu,
        cpu_oracle = crate::shaders::gemm_block_grouped::cpu_oracle,
        gpu = crate::shaders::gemm_block_grouped::gpu_q4,
        fixture = crate::shaders::gemm_block_grouped::tiny_fixture_q4,
        out_len = crate::shaders::gemm_block_grouped::fixture_len,
        formats: [F32],
        max_tol = 0.05,
        min_cos = 0.999,
    }
    ...
    kernel_oracle_matrix! {
        ...
        cpu = crate::shaders::gemm_block_grouped::cpu,
        cpu_oracle = crate::shaders::gemm_block_grouped::cpu_oracle,
        gpu = crate::shaders::gemm_block_grouped::gpu_nvfp4,
        fixture = crate::shaders::gemm_block_grouped::tiny_fixture_nvfp4,
        out_len = crate::shaders::gemm_block_grouped::fixture_len,
        formats: [F32],
        max_tol = 0.05,
        min_cos = 0.999,
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::shaders::gemm_block_grouped::cpu_oracle,
        gpu = crate::shaders::gemm_block_grouped::gpu_q4,
        fixture = crate::shaders::gemm_block_grouped::tile_fixture_q4,
        out_len = crate::shaders::gemm_block_grouped::fixture_len,
        formats: [F32],
        max_tol = 0.05,
        min_cos = 0.999,
    ...
    kernel_oracle_matrix! {
        ...
        cpu_oracle = crate::shaders::gemm_block_grouped::cpu_oracle,
        gpu = crate::shaders::gemm_block_grouped::gpu_nvfp4,
        fixture = crate::shaders::gemm_block_grouped::tile_fixture_nvfp4,
        out_len = crate::shaders::gemm_block_grouped::fixture_len,
        formats: [F32],
        max_tol = 0.05,
        min_cos = 0.999,
