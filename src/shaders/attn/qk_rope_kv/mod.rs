...
pub fn cpu(f: &Fixture) -> Vec<f32> {
    ...
    for v in kvcache.iter_mut() {
        *v = crate::shaders::f16::f16_bits_to_f32(crate::shaders::f16::f32_to_f16_bits(*v));
    }
...
pub fn gpu(f: &Fixture, variant: KernelVariant) -> Result<Vec<f32>, Error> {
    ...
    BufferPool::write_bf16(&buf_kv, &crate::shaders::f16::f32_slice_to_f16(&f.kvcache));
    ...
    // kvcache is f16, not bf16.
    {
        ...
        for (i, o) in kvcache.iter_mut().enumerate() {
            *o = crate::shaders::f16::f16_bits_to_f32(unsafe { *ptr.add(i) });
        }
    }
