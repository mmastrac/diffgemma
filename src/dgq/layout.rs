...
/// Byte-layout arithmetic lives in the shared crate; these names keep their
/// engine paths by re-exporting it. (`Q4_BLOCK_BYTES`/`Q6_BLOCK_BYTES` have no
/// engine caller of their own — they are re-exported for path stability.)
