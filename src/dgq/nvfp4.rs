...
use crate::Error;
use crate::dgq::fp4::{FP4_E2M1_MAX, e2m1_from_f32, fp8_e4m3_from_f32, fp8_e4m3_to_f32};
...
/// NVFP4 decode and its CPU GEMM oracle live in the shared crate; these names
/// keep their engine paths by re-exporting it. (`dequant_row_nvfp4` is called
/// only by the engine's tests; `dequant_matrix_nvfp4` has no engine caller.)
#[allow(unused_imports)]
pub use dgemm::format::nvfp4::{
    dequant_matrix_nvfp4, dequant_matrix_nvfp4_payload, dequant_row_nvfp4, nvfp4_gemm_cpu,
    nvfp4_weight_at,
};
